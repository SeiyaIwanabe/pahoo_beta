...
## 3. ユーザーの様々なアクションに対して通知で知らせる
投稿に対してのコメントやいいね、他ユーザーからフォローされたとき、ダイレクトメッセージが送られたときにユーザーに知らせるための通知機能を実装しました。
...
![ezgif com-gif-maker (13)](https://user-images.githubusercontent.com/67876040/118084305-740b6880-b3fb-11eb-8870-0876ed44575a.gif)
